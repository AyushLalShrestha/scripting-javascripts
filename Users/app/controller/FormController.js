...
Ext.define('Users.controller.FormController', {
	extend: 'Ext.app.Controller',
    alias: 'edit.controller',

    views: ['Users.view.main.FormView'],
    models: ['Users.model.UserModel'],

    view: undefined,
    values: undefined,

    show: function(values) {
				var Form = this.getView('Users.view.main.FormView');
